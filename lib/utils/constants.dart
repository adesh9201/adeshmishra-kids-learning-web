...
import '../models/itemdata_model.dart';
...
class AppConstants {
  ...
  static List<ItemData> numberItems = [
    ItemData(
      ...
      title: '0',
      description: 'zero',
      backgroundColor: const Color.fromARGB(160, 33, 150, 243),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.one),
      title: '1',
      description: 'one',
      backgroundColor: const Color.fromARGB(160, 0, 150, 136),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.two),
      title: '2',
      description: 'two',
      backgroundColor: const Color.fromARGB(160, 255, 152, 0),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.three),
      title: '3',
      description: 'three',
      backgroundColor: const Color.fromARGB(160, 156, 39, 176),
    ),
    ItemData(
    ...
    ItemData(
      ...
      title: '5',
      description: 'five',
      backgroundColor: const Color.fromARGB(160, 63, 81, 181),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.six),
      title: '6',
      description: 'six',
      backgroundColor: const Color.fromARGB(160, 233, 30, 99),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.seven),
      title: '7',
      description: 'seven',
      backgroundColor: const Color.fromARGB(160, 205, 220, 57),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.eight),
      title: '8',
      description: 'eight',
      backgroundColor: const Color.fromARGB(160, 0, 188, 212),
    ),
    ItemData(
      iconAsset: AssetsPath.getNumberImage(Numbers.nine),
      title: '9',
      description: 'nine',
      backgroundColor: const Color.fromARGB(160, 255, 87, 34),
    ),
  ];
